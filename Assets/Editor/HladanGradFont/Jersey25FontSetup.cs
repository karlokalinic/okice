...
{
    public class Jersey25FontSetup : EditorWindow
    {
        ...
        [MenuItem("Tools/HLADAN GRAD/Font Wizard", false, 1000)]
        public static void ShowWindow()
        {
            var window = GetWindow<Jersey25FontSetup>("Font Wizard");
        ...
        private void OnGUI()
        {
            EditorGUILayout.LabelField("HLADAN GRAD Font Wizard", EditorStyles.boldLabel);
