...
namespace PixelCrushers
{
	...
	public class UIPanel : MonoBehaviour, IEventSystemUser
	{
		...
		public virtual void SetFocus(GameObject selectable)
		{
			...
			{
				Selectable selectable2 = ((selectable != null) ? selectable.GetComponent<Selectable>() : null);
				if (selectable2 != null)
				{
					UIUtility.Select(selectable2, allowStealFocus: true, eventSystem);
				}
				else
				{
		...
		{
			if (!monitorSelection || !InputDeviceManager.autoFocus || eventSystem == null || topPanel != this)
			{
				return;
			}
			GameObject currentSelectedGameObject = eventSystem.currentSelectedGameObject;
			if (currentSelectedGameObject == null || !selectables.Contains(currentSelectedGameObject))
			{
				...
				{
					Selectable selectable = ((firstSelected != null) ? firstSelected.GetComponent<Selectable>() : null);
					gameObject = ((selectable != null && selectable.IsActive() && selectable.IsInteractable()) ? firstSelected : GetFirstInteractableButton());
				}
				if (gameObject != null)
				{
