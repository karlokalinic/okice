...
namespace PixelCrushers.DialogueSystem
{
	...
	public class DialogueActor : MonoBehaviour
	{
		...
		protected virtual void OnDisable()
		{
			...
			CharacterInfo.UnregisterActorTransform(this.actor, base.transform);
			if (!DialogueManager.isConversationActive)
			{
				return;
			}
			Actor actor = DialogueManager.masterDatabase.GetActor(this.actor);
			if (actor == null)
			{
				return;
			}
			...
			{
				activeConversation.conversationModel.ClearCharacterInfo(actor.id);
			}
		}
