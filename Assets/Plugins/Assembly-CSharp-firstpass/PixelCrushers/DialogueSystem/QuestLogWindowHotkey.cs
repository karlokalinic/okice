...
namespace PixelCrushers.DialogueSystem
{
	...
	public class QuestLogWindowHotkey : MonoBehaviour
	{
		...
		private void Update()
		{
			if (key != KeyCode.None && !(runtimeQuestLogWindow == null) && !DialogueManager.IsDialogueSystemInputDisabled() && (InputDeviceManager.IsKeyDown(key) || (!string.IsNullOrEmpty(buttonName) && DialogueManager.getInputButtonDown(buttonName))))
			{
