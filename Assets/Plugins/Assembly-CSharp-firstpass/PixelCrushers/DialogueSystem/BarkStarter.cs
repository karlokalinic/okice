...
namespace PixelCrushers.DialogueSystem
{
	...
	public abstract class BarkStarter : ConversationStarter
	{
		...
		protected void PopulateCache(Transform speaker, Transform listener)
		{
			...
			ConversationModel conversationModel = new ConversationModel(DialogueManager.masterDatabase, conversation, speaker, listener, DialogueManager.allowLuaExceptions, DialogueManager.isDialogueEntryValid, -1, stopAtFirstValid: false, DialogueManager.useLinearGroupMode);
