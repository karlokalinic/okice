...
namespace PixelCrushers.DialogueSystem
{
	public static class UITools
	{
		...
		public static void EnableInteractivity(GameObject go)
		{
			...
			{
				GraphicRaycaster graphicRaycaster = go.GetComponentInChildren<GraphicRaycaster>() ?? go.GetComponentInParent<GraphicRaycaster>();
		...
		{
			if (visibility != UIVisibility.UntilSuperceded && visibility != UIVisibility.UntilSupercededOrActorChange)
			{
				return visibility == UIVisibility.UntilSupercededOrActorChangeOrMenu;
			}
			return true;
		}
	}
