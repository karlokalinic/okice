...
namespace PixelCrushers.DialogueSystem
{
	...
	public class UnityUIBarkUI : AbstractBarkUI
	{
		...
		public void Start()
		{
			...
			if (nameText != null)
			{
				nameText.gameObject.SetActive(includeName);
			}
		}
		...
		{
			if (nameText != null && nameText.gameObject != base.gameObject)
			{
				nameText.gameObject.SetActive(value);
			}
			if (barkText != null && barkText.gameObject != base.gameObject)
			{
				barkText.gameObject.SetActive(value);
			}
