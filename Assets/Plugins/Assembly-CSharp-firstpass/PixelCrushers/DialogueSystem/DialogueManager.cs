...
namespace PixelCrushers.DialogueSystem
{
	public static class DialogueManager
	{
		...
		public static bool reevaluateLinksAfterSubtitle
		{
			get
			{
				if (!hasInstance)
				...
				return instance.reevaluateLinksAfterSubtitle;
			}
		}

		public static bool useLinearGroupMode
		{
			get
			{
				if (!hasInstance)
				...
				return instance.useLinearGroupMode;
			}
		}
