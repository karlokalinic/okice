...
namespace PixelCrushers.DialogueSystem
{
	...
	public class OverrideUnityUIDialogueControls : MonoBehaviour
	{
		...
		public virtual void ApplyToDialogueUI(UnityUIDialogueUI ui)
		{
			...
			{
				if (subtitle.continueButton.onClick.GetPersistentEventCount() == 0 || subtitle.continueButton.onClick.GetPersistentTarget(0) == null)
				{
					subtitle.continueButton.onClick.AddListener(ui.OnContinue);
				}
				UnityUIContinueButtonFastForward component = subtitle.continueButton.GetComponent<UnityUIContinueButtonFastForward>();
