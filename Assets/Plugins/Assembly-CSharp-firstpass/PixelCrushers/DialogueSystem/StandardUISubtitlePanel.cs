...
namespace PixelCrushers.DialogueSystem
{
	...
	public class StandardUISubtitlePanel : UIPanel
	{
		...
		protected Coroutine m_showAfterClosingOtherPanelsCoroutine;
		...
		public virtual void OpenOnStartConversation(Sprite portraitSprite, string portraitActorName, string displayName, DialogueActor dialogueActor, StandardDialogueUI dialogueUI)
		{
		...
		protected virtual IEnumerator StartTypingWhenFocused(UITextField subtitleText, string text, int fromIndex)
		{
			...
			if (base.panelState == PanelState.Open)
			{
