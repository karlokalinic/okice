...
namespace PixelCrushers.DialogueSystem
{
	...
	public class UnityUIDialogueUI : CanvasDialogueUI
	{
		...
		protected void CheckForSupercededSubtitle(CharacterType characterType)
		{
			...
			if (UITools.CanBeSuperceded(unityUISubtitleControls.uiVisibility) && unityUISubtitleControls.isVisible)
			{
		...
		public override void ShowResponses(Subtitle subtitle, Response[] responses, float timeout)
		{
			...
			if (findActorOverrides)
			{
				...
				{
					dialogue.responseMenu = ((overrideUnityUIDialogueControls != null && overrideUnityUIDialogueControls.responseMenu.panel != null) ? overrideUnityUIDialogueControls.responseMenu : originalResponseMenu);
				}
				else
				{
