namespace PixelCrushers.DialogueSystem
{
	public static class TypewriterUtility
	{
		public static AbstractTypewriterEffect GetTypewriter(UITextField textField)
		{
			...
			{
				abstractTypewriterEffect = textField.textMeshProUGUI.GetComponent<AbstractTypewriterEffect>();
			}
			if (abstractTypewriterEffect == null && textField.uiText != null)
			{
				abstractTypewriterEffect = textField.uiText.GetComponent<AbstractTypewriterEffect>();
			}
