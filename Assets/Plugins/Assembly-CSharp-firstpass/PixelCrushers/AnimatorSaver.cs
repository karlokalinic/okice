	...
	public class AnimatorSaver : Saver
	{
		...
		public override string RecordData()
		{
			...
			for (int j = 0; j < animator.parameterCount; j++)
			{
				...
				{
					float num5 = animator.GetFloat(animatorControllerParameter.name);
					if (num2 < m_data.floats.Count)
					{
						m_data.floats[num2] = num5;
					}
					else
					{
						m_data.floats.Add(num5);
					}
					num2++;
					break;
				}
				...
				case AnimatorControllerParameterType.Trigger:
				{
					...
					if (num4 < m_data.triggers.Count)
					{
						m_data.triggers[num4].isTriggered = isTriggered;
						m_data.triggers[num4].name = animatorControllerParameter.name;
					}
					else
					{
