...
namespace HutongGames.PlayMaker
{
	...
	public class FsmProperty
	{
		...
		public NamedVariable GetVariable()
		{
			...
			if ((object)PropertyType == typeof(GameObject))
			{
				return GameObjectParameter;
			}
			if ((object)PropertyType == typeof(Material))
			{
				return MaterialParameter;
			}
			if ((object)PropertyType == typeof(Texture))
			{
		...
		public void SetPropertyName(string propertyName)
		{
			...
			if (!string.IsNullOrEmpty(PropertyName))
			{
				if ((object)TargetType != null)
				{
					...
					if (TargetType.IsSubclassOf(typeof(UnityEngine.Object)) && (object)PropertyType != null)
					{
		...
		public void SetValue()
		{
			...
			else if ((object)PropertyType == typeof(GameObject) && !GameObjectParameter.IsNone)
			{
				ReflectionUtils.SetMemberValue(memberInfo, targetObjectCached, GameObjectParameter.Value);
			}
			else if ((object)PropertyType == typeof(Material) && !MaterialParameter.IsNone)
			{
				ReflectionUtils.SetMemberValue(memberInfo, targetObjectCached, MaterialParameter.Value);
			}
			else if ((object)PropertyType == typeof(Texture) && !TextureParameter.IsNone)
			{
				ReflectionUtils.SetMemberValue(memberInfo, targetObjectCached, TextureParameter.Value);
			}
			else if ((object)PropertyType == typeof(Color) && !ColorParameter.IsNone)
			{
		...
		public void Init()
		{
			...
			if ((object)PropertyType != null && PropertyType.IsEnum && !FsmString.IsNullOrEmpty(StringParameter))
			{
		...
		{
			if (!initialized || targetObjectCached != TargetObject.Value || (TargetObject.UseVariable && (object)TargetType != TargetObject.ObjectType))
			{
				Init();
			}
		}
