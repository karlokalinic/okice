namespace HutongGames.PlayMaker.Actions
{
	...
	public class GetCollision2dInfo : FsmStateAction
	{
		...
		private void StoreCollisionInfo()
		{
			...
			enabled.Value = base.Fsm.Collision2DInfo.enabled;
			...
			if (base.Fsm.Collision2DInfo.contacts != null && base.Fsm.Collision2DInfo.contacts.Length != 0)
			{
				...
				{
					contactPoint2d.Value = base.Fsm.Collision2DInfo.contacts[0].point;
				}
				if (!contactNormal2d.IsNone)
				{
					contactNormal2d.Value = base.Fsm.Collision2DInfo.contacts[0].normal;
				}
			}
		}
