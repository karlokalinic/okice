	...
	public class GetStatus : FsmStateAction
	{
		...
		public override void OnEnter()
		{
			if (asset1 != null && asset2 != null && storeResult != null)
			{
				try
				{
					storeResult.Value = Lua.Run(string.Format("return GetStatus({0}, {1})", asset1.Value.Replace("\"", "'").Replace(" ", "_").Replace("-", "_"), asset2.Value.Replace("\"", "'").Replace(" ", "_").Replace("-", "_")), DialogueDebug.LogInfo).AsString;
				}
