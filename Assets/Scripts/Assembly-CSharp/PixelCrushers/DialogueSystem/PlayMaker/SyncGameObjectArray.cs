...
namespace PixelCrushers.DialogueSystem.PlayMaker
{
	...
	[Tooltip("Syncs a GameObject array variable between PlayMaker and the Dialogue System's Variable[] Lua table.")]
	public class SyncGameObjectArray : FsmStateAction
	{
		...
		[Tooltip("The PlayMaker array variable")]
		[ArrayEditor(VariableType.GameObject, "", 0, 0, 65536)]
		public FsmArray playMakerVariable;

		[RequiredField]
		[Tooltip("If ticked, copy PlayMaker value to Dialogue System; if unticked, copy Dialogue System value to PlayMaker and assume named GameObjects exist in scene")]
		...
		public override void Reset()
		{
			...
			playMakerVariable = new FsmArray
			{
				UseVariable = true
			};
