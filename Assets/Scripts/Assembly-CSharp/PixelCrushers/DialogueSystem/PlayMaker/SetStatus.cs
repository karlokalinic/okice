...
namespace PixelCrushers.DialogueSystem.PlayMaker
{
	...
	public class SetStatus : FsmStateAction
	{
		...
		public override void Reset()
		{
			if (asset1 != null)
			{
				asset1.Value = string.Empty;
			}
			if (asset2 != null)
			{
				asset2.Value = string.Empty;
			}
			if (statusValue != null)
			{
				statusValue.Value = string.Empty;
			}
		}
		...
		public override void OnEnter()
		{
			if (asset1 != null && asset2 != null && statusValue != null)
			{
				try
				{
					Lua.Run(string.Format("SetStatus({0}, {1}, \"{2}\")", asset1.Value.Replace("\"", "'").Replace(" ", "_").Replace("-", "_"), asset2.Value.Replace("\"", "'").Replace(" ", "_").Replace("-", "_"), DialogueLua.DoubleQuotesToSingle(statusValue.Value)), DialogueDebug.LogInfo);
				}
