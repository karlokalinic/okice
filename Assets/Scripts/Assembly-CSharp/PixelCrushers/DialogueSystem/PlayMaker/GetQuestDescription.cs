...
namespace PixelCrushers.DialogueSystem.PlayMaker
{
	...
	public class GetQuestDescription : FsmStateAction
	{
		...
		public override void OnEnter()
		{
			...
			{
				storeResult.Value = ((state == null || string.IsNullOrEmpty(state.Value)) ? QuestLog.GetQuestDescription(questName.Value) : QuestLog.GetQuestDescription(questName.Value, QuestLog.StringToState(state.Value.ToLower())));
			}
			Finish();
		}
	}
